...
# print(working_dir)
# print(sys.path)
from Problem_Set_Easy import problems_easy_dict
from Problem_Set_Easy import correct_answers_dict
...
def ask_gpt(question):
    ...
    appended_question = (
        question + " Provide strictly JUST the numerical value (no other words)."
    )
